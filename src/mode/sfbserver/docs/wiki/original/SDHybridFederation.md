...
graph LR
  ...
  SDHybridFederation(SDHybridFederation) --1--> ADEdgeServerAvailable[ADEdgeServerAvailable]
  SDHybridFederation --2--> ADCheckSecurityGroupMembership[ADCheckSecurityGroupMembership]
  SDHybridFederation --3--> ADIsSfbServerAdminAccount[ADIsSfbServerAdminAccount]
  SDHybridFederation --4--> ADCheckSIPHostingProvider[ADCheckSIPHostingProvider]
  SDHybridFederation --5--> ADCheckEdgeConfiguration[ADCheckEdgeConfiguration]
  SDHybridFederation --6--> ADCheckEdgePoolConfiguration[ADCheckEdgePoolConfiguration]
  SDHybridFederation --7--> ADCompareOnPremToOnline[ADCompareOnPremToOnline]
  SDHybridFederation --8--> ADCheckFederatedDomain[ADCheckFederatedDomain]
  SDHybridFederation --9--> ADCheckFederationDNSRecords[ADCheckFederationDNSRecords]
  SDHybridFederation --10--> ADCertificateCheck[ADCertificateCheck]

  PDTenantUserID[\PDTenantUserID\] -.-> SDHybridFederation
  PDTenantPassword[\PDTenantPassword\] -.-> SDHybridFederation
  ...
  ADCheckFederatedDomain --8.1--> RDCheckDomainApprovedForFederation[RDCheckDomainApprovedForFederation]
  ADCheckFederationDNSRecords --9.1--> RDCheckEdgeExternalDNS[RDCheckEdgeExternalDNS]
  ADCheckFederationDNSRecords --9.2--> RDCheckLocalDomainFederationDNSRecord[RDCheckLocalDomainFederationDNSRecord]
  ADCheckFederationDNSRecords --9.2--> RDCheckFederatedDomainDNSRecords[RDCheckFederatedDomainDNSRecords]
  ADCertificateCheck--> |10.1| RDCheckEdgeCerts[RDCheckEdgeCerts]
:::
